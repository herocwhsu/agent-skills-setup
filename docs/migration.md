...
- **`~/.kiro/steering/engineering-rules.md`** receives the 12 core engineering rules plus the spec-gated workflow policy (Part IV). Deployed by `bash scripts/install-agents-md.sh`.
