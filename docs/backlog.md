...
### 小修：Operator Memo 標籤更名 ✅ 已完成（2026-06-29）

- [x] `InsightDetailPage.tsx`：標題從 `Operator Memo` 改為 `Historical Context`
- [x] 在備忘框下方加一行小字免責聲明：「For educational reference only — not investment advice.」
