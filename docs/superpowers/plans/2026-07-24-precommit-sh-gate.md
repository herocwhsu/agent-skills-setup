...
**Status: shipped.** Evidence: `.claude/hooks/precommit-sh-check.sh`, registered as a PreToolUse hook in `.claude/settings.json`, with `.claude/hooks/tests/test_precommit_sh_check.sh` (10 tests).
