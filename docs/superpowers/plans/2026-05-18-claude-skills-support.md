...
```bash
grep -n "kiro" /Users/herohsu/Project/agent-skills-setup/skills/fetch-page-to-markdown/SKILL.md
```
...
```bash
git -C /Users/herohsu/Project/agent-skills-setup add skills/fetch-page-to-markdown/SKILL.md
git -C /Users/herohsu/Project/agent-skills-setup commit -m "fix: make fetch-page-to-markdown skill agent-agnostic"
```
...
```bash
grep -n "kiro" /Users/herohsu/Project/agent-skills-setup/skills/fetch-jira-story/SKILL.md
```
...
```bash
git -C /Users/herohsu/Project/agent-skills-setup add skills/fetch-jira-story/SKILL.md
git -C /Users/herohsu/Project/agent-skills-setup commit -m "fix: make fetch-jira-story skill agent-agnostic"
```
...
```bash
grep -n "kiro" /Users/herohsu/Project/agent-skills-setup/skills/plan-story/SKILL.md
```
...
```bash
git -C /Users/herohsu/Project/agent-skills-setup add skills/plan-story/SKILL.md
git -C /Users/herohsu/Project/agent-skills-setup commit -m "fix: make plan-story skill agent-agnostic"
```
...
```bash
grep -n "kiro" /Users/herohsu/Project/agent-skills-setup/skills/create-story-tasks/SKILL.md
```
...
```bash
git -C /Users/herohsu/Project/agent-skills-setup add skills/create-story-tasks/SKILL.md
git -C /Users/herohsu/Project/agent-skills-setup commit -m "fix: make create-story-tasks skill agent-agnostic"
```
...
```bash
cd /Users/herohsu/Project/agent-skills-setup && bash scripts/install.sh
...
Expected: each is a symlink pointing into `/Users/herohsu/Project/agent-skills-setup/skills/`.
...
```bash
git -C /Users/herohsu/Project/agent-skills-setup add README.md
git -C /Users/herohsu/Project/agent-skills-setup commit -m "docs: document Claude Code support for custom skills"
```
...
```bash
cat /Users/herohsu/Project/agent-skills-setup/skills/fetch-page-to-markdown/README.md
```
...
```bash
git -C /Users/herohsu/Project/agent-skills-setup add skills/fetch-page-to-markdown/README.md
git -C /Users/herohsu/Project/agent-skills-setup commit -m "docs: add agent compatibility note to fetch-page-to-markdown README"
```
