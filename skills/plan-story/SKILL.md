...
| `branch` | `<STORY-ID>-t<N>` e.g. `EXAMPLE-100-t1` |
...
```markdown
# EXAMPLE-100 Implementation Plan
...
| Branch name conflicts | Always prefix with story ID: `EXAMPLE-100-t1` not just `t1` |
