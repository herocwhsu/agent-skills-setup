...
Don't try to read non-default branches via the MCP or REST. The MCP package source has zero `branch` strings (`grep -i branch dist/index.js`); the REST path silently redirects. Both verified 2026-06-18.
